...
public class GraphTraversalUtil {
    ...
    /**
     * Depth first search algorithm helper method helps sort a map of discovery edges for 
     * depth first search method
     * @param <V> the type of data in the graph vertices
     * @param <E> the type of data in graph edges
     * @param graph a graph to traverse
     * @param u the vertex at which to start the depth-first search traversal
     * @param known a set of visited vertices
     * @param forest a map of discovery edges with their vertices
     */
    private static <V, E> void dfsHelper(Graph<V, E> graph, Vertex<V> u, Set<Vertex<V>> known, Map<Vertex<V>, Edge<E>> forest) {
       known.add(u); // u = vertex v
