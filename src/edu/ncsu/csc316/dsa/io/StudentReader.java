...
public class StudentReader {
	...
	private static Student processLine(String line) {
		...
		String idString = "";
		String gpaString = "";
		String creditHoursString = "";
		
		Scanner scanStudent = new Scanner(line);
		scanStudent.useDelimiter(",");
		
		first = scanStudent.next();
		last = scanStudent.next();
		unityID = scanStudent.next();
		idString = scanStudent.next();
		gpaString = scanStudent.next();
		creditHoursString = scanStudent.next();
		
		scanStudent.close();
		int id = Integer.valueOf(idString);
		int creditHours = Integer.valueOf(creditHoursString);
