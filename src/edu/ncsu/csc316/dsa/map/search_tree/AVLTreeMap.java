...
public class AVLTreeMap<K extends Comparable<K>, V> extends BinarySearchTreeMap<K, V> {
     ...
     * performed.
     * Used Data Structures and Algorithms Course Book pg 487 Chapter 11 for reference in this method
