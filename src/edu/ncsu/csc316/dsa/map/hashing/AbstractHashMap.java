...
public abstract class AbstractHashMap<K, V> extends AbstractMap<K, V> {
    ...
    /**
     * Adds an Entry to an AbstractHashMap
     * @param key the key connected to the entry that will be added to an Abstract
     * HashMap
     * @param value the value connected to the entry that will be added to an Abstract
     * HashMap
     * @return ret the value that was updated if an entry already exists or null if a new value was added
     */
    @Override
    ...
    /**
     * Gets the value connected to an Entry in a AbstractHashMap
     * @param key the key connected to an Entry in an AbstractHashMap
     * @return V the value connected to an Entry in an AbstractHashMap
     */
    @Override
    public V get(K key) {
    ...
    /**
     * Removes an entry from an AbstractHashMap, locates the Entry with passed key parameter
     * @param key the key that could be connected an Entry in an AbstractHashMap
     * @return V a value connected to an Entry in an AbstractHashMap that was removed, otherwise this will return
     * as null if there not an Entry that exists with the passed key parameter
     */
    @Override
