...
public class HeapPriorityQueue<K extends Comparable<K>, V> extends AbstractPriorityQueue<K, V> {
     ...
     * 
     * @param comparator compare the custom Comparator to use when comparing keys (priorities)
     */
    ...
    /**
     * Inserts an entry within HeapPriorityQueue by using a passed key and value to construct
     * an entry that will be added to HeapPriorityQueue
     * Referenced Data Structures and Algorithms Course Book Pg 378 Chapter 9 while creating this method
     * @param key the key connected to the entry that will be constructed and added to HeapPriorityQueue
     * @param value the value connected to the entry that will be constructed and added to HeapPriorityQueue
     * @return temp the newly constructed entry
     */
    @Override
    ...
    /**
     * Finds the minimum entry (the smallest entry, aka the entry with the smallest key)
     * Referenced Data Structures and Algorithms Course Book Pg 378 Chapter 9 while creating this method
     * @return Entry the minimum entry
     */
    @Override
    ...
    /**
     * Removes the minimum entry from the HeapPriorityQueue
     * Referenced Data Structures and Algorithms Course Book Pg 378 Chapter 9 while creating this method
     * @return answer the minimum entry that was removed from HeapPriorityQueue
     */
    @Override
    ...
    /**
     * Returns the size of the HeapPriorityQueue
     * @return Integer the size of the HeapPriorityQueue
     */
    @Override
    public int size() {
        return list.size();
     ...
     * Referenced Data Structures and Algorithms Course Book Pg 377 Chapter 9 while creating this method
