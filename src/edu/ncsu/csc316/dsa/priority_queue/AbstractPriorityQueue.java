...
public abstract class AbstractPriorityQueue<K extends Comparable<K>, V> implements PriorityQueue<K, V> {
	/** A comparator that will be constructed and used to compare entries within AbstractPriorityQueue */
    ...
    /**
     * Delegates to the {Comparable#compareTo) implementation that defines the
    ...
    public class NaturalOrder implements Comparator<K> {
    	/**
    	 * Compares two keys to determine their ordering using Natural Ordering
    	 * @param first the first key that will be compared
    	 * @param second the second key that will be compared
    	 * @return Integer a value indicating the positioning of an entry within AbstractPriorityQueue, 1 = after second entry, 0 = same precedence, -1 = after second
    	 * entry
    	 */
    ...
    public static class PQEntry<K, V> implements Entry<K, V> {
    	/** The key connected to a PQEntry*/
        private K key;
        /** The value connected to a PQEntry */
        private V value;
        ...
        /**
         * Gets the key connected to the PQEntry
         * @return key the key connected to the PQEntry
         */
        @Override
        public K getKey() {
            return key;
        ...
        /**
         * Gets the value connected to the PQEntry
         * @return value the value connected to PQEntry
         */
        @Override
        public V getValue() {
            return value;
     ...
     * @return Entry the newly constructed entry
     */
