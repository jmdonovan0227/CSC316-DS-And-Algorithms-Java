...
/**
 * Tests Adjacency List Class
 * @author Jake Donovan
 *
 */
public class AdjacencyListGraphTest {
	    /** A graph of strings and integers which represents an undirected graph that will be used for testing */
	    private Graph<String, Integer> undirectedGraph;
	    /** A graph of strings and integers which represents a directed graph that will be used for testing*/
	    ...
	    public void testRemoveVertex() {
	        ...
	        assertEquals("Vertex is not a valid adjacency list vertex.", e.getMessage());
	    ...
	    public void testRemoveEdge() {
	        ...
	        assertEquals("Edge is not a valid adjacency list edge.", e.getMessage());
