...
/**
 * Testss AdjacencyMatrixGraph class
 * @author Jake Donovan
 *
 */
public class AdjacencyMatrixGraphTest {
	    /** A graph of strings and integers that will represent our undirected graph for testing purposes */
	    private Graph<String, Integer> undirectedGraph;
	    /** A graph of strings and integers that will represent our directed graph for testing purposes */
	    ...
	    public void testRemoveVertex() {
	        ...
	        assertEquals("Vertex is not a valid adjacency matrix vertex.", e.getMessage());
