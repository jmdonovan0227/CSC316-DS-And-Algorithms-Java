...
/**
 * Tests AdjacencyMapGraph class
 * @author Jake Donovan
 *
 */
public class AdjacencyMapGraphTest {
	    /** A graph of strings and integers which will represent our undirected graph for testing purposes */
	    private Graph<String, Integer> undirectedGraph;
	    /** A graph of strings and integers which will represent our directed graph for testing purposes */
	    ...
	    /**
	     * Builds our undirected graph (populates)
	     */
	    ...
	    /**
	     * Builds our directed graph (populates)
	     */
	    ...
	    public void testOutDegree() {
	        ...
	        itD = directedGraph.outgoingEdges(v2).iterator();
	        ...
	        itD = directedGraph.outgoingEdges(v3).iterator();
	        ...
	        itD = directedGraph.outgoingEdges(v4).iterator();
	        ...
	        itD = directedGraph.outgoingEdges(v5).iterator();
	        temp = (Edge<Integer>[])(new Edge[1]);
	        count = 0;
	        temp[count] = itD.next();
	        count++;
	    ...
	    public void testInDegree() {
	        ...
	        temp[count] = itDTwo.next();
	        count++;
	        assertFalse(itDTwo.hasNext());
	        assertTrue(arrayContains(temp, e1));
	        temp = (Edge<Integer>[])(new Edge[2]);
	        count = 0;
	        Iterator<Edge<Integer>> itDThree = directedGraph.incomingEdges(v3).iterator();
	        temp[count] = itDThree.next();
	        count++;
	        temp[count] = itDThree.next();
	        count++;
	        assertFalse(itDThree.hasNext());
	        assertTrue(arrayContains(temp, e2));
	        assertTrue(arrayContains(temp, e5));
	        temp = (Edge<Integer>[])(new Edge[3]);
	        count = 0;
	        Iterator<Edge<Integer>> itDFour = directedGraph.incomingEdges(v4).iterator();
	        temp[count] = itDFour.next();
	        count++;
	        temp[count] = itDFour.next();
	        count++;
	        temp[count] = itDFour.next();
	        count++;
	        assertFalse(itDFour.hasNext());
	        assertTrue(arrayContains(temp, e3));
	        assertTrue(arrayContains(temp, e6));
	        assertTrue(arrayContains(temp, e8));
	        temp = (Edge<Integer>[])(new Edge[4]);
	        ...
	        temp[count] = itDSix.next();
	        count++;
	        assertFalse(itDSix.hasNext());
	        assertTrue(arrayContains(temp, e11));
	    }
	    ...
	    public void testRemoveVertex() {
	        ...
	        assertEquals("Vertex is not a valid adjacency map vertex.", e.getMessage());
