...
public class SearchTableMapTest {
    ...
    /** A map of Students and Integers */
    ...
    public void testPut() {
        ...
        assertEquals("string3", map.put(3, "updated"));
    }
    ...
    public void testStudentMap() {
        ...
        assertEquals(-1, (int)entry.compareTo(it.next()));
    ...
    public void testEntrySet() {
        ...
        assertTrue(it.hasNext());
        Integer x = keyIterator.next();
        assertEquals(-1, x.compareTo(keyIterator.next()));
        Exception e = assertThrows(UnsupportedOperationException.class, () -> keyIterator.remove());
        assertEquals("The remove operation is not supported yet.", e.getMessage());
    }
    ...
    public void testValues() {
        ...
        assertEquals(-1, itNext.compareTo(it.next()));
        Exception e = assertThrows(UnsupportedOperationException.class, () -> it.remove());
        assertEquals("The remove operation is not supported yet.", e.getMessage());
    }
}
