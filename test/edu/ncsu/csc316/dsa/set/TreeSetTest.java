...
public class TreeSetTest {
	/** A set of Integers that will be constructed and used to test TreeSet class methods */
    ...
    public void testRetainAll() {
        ...
        // test that all elements except for 30 are contained with set after a call to retainAll(other)
        set.retainAll(other);
        assertEquals(2, set.size());
        assertTrue(set.contains(10));
        assertTrue(set.contains(20));
    ...
    public void testRemoveAll() {
        ...
        // Test that elements contained within other are removed after a call to removeAll(other)
        set.removeAll(other);
        assertEquals(3, set.size());
        assertTrue(set.contains(5));
        assertTrue(set.contains(15));
    ...
    public void testAddAll() {
        ...
        // Test that a call to addAll(other) adds all elements in created set to class contructed set
        set.addAll(other);
