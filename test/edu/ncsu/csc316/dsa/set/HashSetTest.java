...
public class HashSetTest {
	/** A HashMap set of integers that will be used in this test class */
    private Set<Integer> set;
    /** A HashMap set of integers that will be used for testing in this class */
    ...
    public void testRetainAll() {       
          ...
          // test that only 10 is saved when calling retainAll(other)
          set.retainAll(other);
          assertEquals(1, set.size());
          assertTrue(set.contains(10));
          assertFalse(set.contains(5));
    ...
    public void testRemoveAll() {
         ...
         // test the removeAll(other) that "set" now only contains 5 and 15
         set.removeAll(other);
         assertEquals(2, set.size());
         assertFalse(set.contains(10));
         assertTrue(set.contains(5));
    ...
    public void testAddAll() {
         ...
         // test that addAll(other) adds all elements in other to "set"
         set.addAll(other);
